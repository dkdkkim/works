try:
    ...
    output_path = "/homea/dkkim/works"
    study_path = glob(data_path+"/*/*/*/*")
    ...
    for didx, path in enumerate(study_path, 1):
        series_path=glob(path+"/*")
    ...
    with open(output_path + '/dicom_log_' + k + '.json', 'w') as outfile:
        json.dump(dicom_log, outfile)
